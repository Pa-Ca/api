...
@Component
public class ValidateTaxOwnerInterceptor implements HandlerInterceptor {

    @Inherited
    @Documented
    @Retention(RetentionPolicy.RUNTIME)
    @Target({ ElementType.TYPE, ElementType.METHOD })
    public @interface ValidateTaxOwner {
    }
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        ValidateTaxOwner annotation = AnnotationUtils.findAnnotation(method, ValidateTaxOwner.class);
        if (annotation != null) {
