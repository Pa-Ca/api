...
public class AuthServiceTest extends ServiceTest {
        ...
        @Test
        void shouldGetNotFoundDueToUserDoesNotExistsInResetPasswordRequest() {
                String email = "test@test.com";
        ...
        @Test
        void shouldGetNotFoundDueToUserDoesNotExistsInResetPassword() {
                String password = "12345678";
                String email = "test@test.com";
                String token = "eyJhbGciOiJIUzI1NiJ9..._9L5L9hJXCX4WPgpks";
        ...
        @Test
        void shouldGetNotFoundDueToUserDoesNotExistsInVerifyEmailRequest() {
                String email = "test@test.com";
        ...
        @Test
        void shouldGetNotFoundDueToUserDoesNotExistsInVerifyEmail() {
                String email = "test@test.com";
                String token = "eyJhbGciOiJIUzI1NiJ9..._9L5L9hJXCX4WPgpks";
