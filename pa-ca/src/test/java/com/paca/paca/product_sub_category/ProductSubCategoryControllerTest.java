...
import com.paca.paca.product_sub_category.controller.ProductSubCategoryController;
...
public class ProductSubCategoryControllerTest extends ControllerTest {
    ...
    public void shouldGetForbiddenDueToInvalidRoleInGetProductSubCategoryList() throws Exception {
        ...
        ProductSubCategoryListDTO productSubCategoryListDTO = ProductSubCategoryListDTO.builder().productSubCategories(dtoList).build();
    ...
    public void shouldGetProductCategoryList() throws Exception {
        ...
        ProductCategoryListDTO productCategoryListDTO = ProductCategoryListDTO.builder().productCategories(dtoList).build();
        ...
        mockMvc.perform(get(ProductSubCategoryStatics.Endpoint.PATH.concat("/categories"))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.productCategories", CoreMatchers.hasItems()));
    }
    ...
    public void shouldGetNoContentInSaveProductSubCategory() throws Exception {
        ...
        when(productSubCategoryService.save(any(ProductSubCategoryDTO.class))).thenThrow(new NoContentException("message", 0));
    ...
    public void shouldSaveProductSubCategory() throws Exception {
        ...
        mockMvc.perform(post(ProductSubCategoryStatics.Endpoint.PATH)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.categoryId", CoreMatchers.is(dto.getCategoryId().intValue())))
    ...
    public void shouldGetForbiddenDueToInvalidUserInUpdateProductSubCategoryById() throws Exception {
        ...
        when(productSubCategoryRepository.existsByIdAndBranch_Business_Id(anyLong(), anyLong())).thenReturn(false);
    ...
    public void shouldGetNoContentInUpdateProductSubCategoryById() throws Exception {
        ...
        when(productSubCategoryService.update(anyLong(), any(ProductSubCategoryDTO.class))).thenThrow(new NoContentException("message", 0));
        when(businessRepository.findByUserEmail(any(String.class))).thenReturn(Optional.ofNullable(business));
        when(productSubCategoryRepository.existsByIdAndBranch_Business_Id(anyLong(), anyLong())).thenReturn(true);
